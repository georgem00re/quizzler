			...
			<div class="modal-background" style={modalBackground}>
				<div class="modal-content">
					<div class="box" style={{ backgroundColor }}>
						...
						<LineDivider/>
						<h2 style={{ margin: "0px", fontFamily: "Avenir", color: textColor }}>Question Source: <a style={{ color: linkColor }} href="https://the-trivia-api.com/">the-trivia-api.com</a></h2>
						<LineDivider/>
						<h2 style={{ fontFamily: "Avenir", color: textColor }}>Source Code: <a style={{ color: linkColor }} href="https://github.com/georgem00re/quizzler.io">github.com/georgem00re/quizzler.io</a></h2>
					</div>
				</div>
			</div>
		</div>
